...
#define KMH_TO_MPH              (1.0f/1.60934f)
	...
	class NewVehicle : public LogicComponent, public PowerupPicker, public DriveableObject, public CheckpointPicker
	{
		URHO3D_OBJECT(NewVehicle, LogicComponent)

	public:
		/// Construct.
		NewVehicle(Context* context);
		~NewVehicle();
	...
	protected:
		...
		float   m_fwheelWidth;
		float   m_fFrontwheelFriction;
        float   m_fRearwheelFriction;
